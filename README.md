...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/btccz-lab-0a92)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/btccz-lab-0a92
```

A live public deployment of this template is available at [https://btccz-lab-0a92.templates.workers.dev](https://btccz-lab-0a92.templates.workers.dev)
